...
<body>
	...
	<div class="layui-row" style="padding-top: 20px">
		...
		<form class="layui-form" action="/Customer/assigneServe" method="post">
			<div class="layui-form-item">
				<label for="username" class="layui-form-label"> <span
					class="x-red">*</span>服务编号:
				</label>
				<div class="layui-input-inline">
					<input type="text" id="serveid" name="serveid" readonly="readonly" value="${Serve.serveid}"
						lay-verify="required" autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<label for="username" class="layui-form-label"> <span
					class="x-red">*</span>处理人:
				</label>
				<div class="layui-input-inline">
					<select id="serdealid" name="serdealid" required="required">
