...
<body>
	<div class="x-body">
		<form class="layui-form" action="/Customer/addOrders" method="post">
			<div class="layui-form-item">
				<label class="layui-form-label"> <span class="x-red">*</span>客户名称
				</label>
				<div class="layui-input-block" style="width: 150px;">
					<select name="custid" lay-verify="required" lay-search="">
						<c:forEach items="${Customerlist}" var="cust">
							<option value="${cust.getCustid()}" name="custid">${cust.getCustname()}</option>
						</c:forEach>
					</select>
				</div>
			</div>
