...
<body>
	<div class="layui-row">
		...
		<div class="layui-col-xs6">
			<form class="layui-form" action="/Customer/addCustomer">
				<div class="grid-demo">
						...
						<div class="layui-col-xs12">
							<div class="grid-demo grid-demo-bg1">
								<div class="layui-form-item">
									...
									<select name="custname" lay-verify="required" lay-search=""
											class="layui-input" id="custname">
											<option value="">点击选择客户名称</option>
