	...
	<div class="x-body">
		<div class="layui-row" style="padding-top: 20px">
			...
			<div class="layui-col-md6">
				<form class="layui-form" action="/Customer/modifyNews" method="post">

					<div class="layui-form-item">
						<label class="layui-form-label"> <span class="x-red">*</span>新闻ID
						</label>
						<div class="layui-input-inline">
							<input type="text" id="name" name="newsid" required=""
							 autocomplete="off" class="layui-input layui-disabled"
								value="${news.newsid}" readOnly="true">
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-inline">
							<input type="text" class="layui-input" id="hiredate"
								name="newsdate" value="${news.newsdate}">
						</div>
						<script>
							...
							<c:choose>
								...
								<c:when test="${news.newsstatus == 0 }">
									...
									<input type="checkbox" name="newsstatus" lay-text="开启|停用"
										lay-skin="switch" lay-filter="switch" value="0" checked>
								</c:when>
